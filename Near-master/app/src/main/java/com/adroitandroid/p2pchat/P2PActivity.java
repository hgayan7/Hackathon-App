...
import com.adroitandroid.p2pchat.databinding.ActivityP2pBinding;
...
public class P2PActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_p2p);
    ...
    private NearDiscovery.Listener getNearDiscoveryListener() {
        return new NearDiscovery.Listener() {
            ...
            public void onDiscoverableTimeout() {
                Toast.makeText(P2PActivity.this, "You're not discoverable anymore", Toast.LENGTH_LONG).show();
            }
        };
    }
                ...
                if (bytes != null) {
                    switch (new String(bytes)) {
                        case MESSAGE_REQUEST_START_CHAT:
                            new AlertDialog.Builder(P2PActivity.this)
    ...
    private void stopNearServicesAndStartChat(Host sender) {
        ...
        ChatActivity.start(P2PActivity.this, sender);
    }
